...
output_prefetchers = [
    'sms_pc+addr',
    'bingo_multitable_pc+addr_pc+offs',
    'bingo_multitable_pc+addr_pc+offs_addr',
    'bingo_multitable_pc+addr_pc+offs_addr_pc',
    'bingo_multitable_pc+addr_pc+offs_addr_pc_offs'
]
